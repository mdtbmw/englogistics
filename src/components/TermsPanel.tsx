    ...
    <div className="pt-32 md:pt-40 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full text-left animate-slide-up">
      ...
      <section id="terms-hero" className="mb-12 bg-gradient-to-br from-[#0F0F8B] to-[#080870] rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden text-white shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl">
          <h2 className="text-[14px] font-bold text-[#0000FD] uppercase tracking-widest mb-3 font-mono">Operations Desk</h2>
          ...
          <div className="flex gap-4">
            <button 
              ...
              className="bg-[#0000FD] text-[#080870] text-[14px] font-bold px-6 py-3.5 rounded-xl hover:bg-white transition-all uppercase tracking-widest active:scale-95 cursor-pointer shadow-lg shadow-[#0F0F8B]/30"
            >
              Open Booking Desk
            </button>
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-16">
        <div className="lg:col-span-4 text-left">
          <span className="text-[13px] font-bold text-zinc-400 uppercase tracking-widest block mb-2 font-mono">Overview & Compliance</span>
          ...
          {termsSections.map((sec) => (
            <div key={sec.num} className="bg-zinc-50 border border-zinc-150 rounded-2xl p-6 md:p-8 flex gap-6 items-start hover:border-[#0F0F8B]/25 transition-all">
              ...
              <div>
                ...
                <p className="text-[13.5px] text-zinc-500 leading-relaxed font-sans">{sec.content}</p>
              </div>
            </div>
          ))}
        </div>
