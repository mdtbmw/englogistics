...
export default function TermsPanel({ setView }: TermsPanelProps) {
  ...
  return (
    <div className="pt-32 md:pt-40 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full text-left animate-slide-up">
      ...
      {/* Header Section */}
      <section id="terms-hero" className="mb-12 bg-gradient-to-br from-[#0f2b5e] to-[#071a3d] rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden text-white shadow-2xl">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-16">
        <div className="lg:col-span-4 text-left">
          <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest block mb-2 font-mono">Overview & Compliance</span>
