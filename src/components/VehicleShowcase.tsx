      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
              ...
              <div className="bg-[#080870]/80 rounded-[calc(2rem-0.375rem)] p-6 min-h-[440px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.03)] flex flex-col justify-between gap-6">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-[11px] font-bold font-mono text-[#0000FD] uppercase tracking-widest">
                      ...
                      {!showSpecialFeatures ? (
                        <div className="grid grid-cols-3 gap-2.5">
                          <div className="bg-[#0A0A78]/60 border border-[#0F0F8B]/20 rounded-xl p-3 flex flex-col gap-1 items-center">
                            ...
                            <span className="text-[9.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Pax Cap</span>
                          ...
                          <div className="bg-[#0A0A78]/60 border border-[#0F0F8B]/20 rounded-xl p-3 flex flex-col gap-1 items-center">
                            ...
                            <span className="text-[9.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Luggage</span>
                          ...
                          <div className="bg-[#0A0A78]/60 border border-[#0F0F8B]/20 rounded-xl p-3 flex flex-col gap-1 items-center">
                            ...
                            <span className="text-[9.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Class</span>
                        ...
                        <div className="flex flex-col gap-2.5 bg-[#0A0A78]/40 border border-[#0F0F8B]/20 rounded-xl p-3.5 text-xs">
                          <div className="flex justify-between border-b border-[#0F0F8B]/20 pb-1.5">
                            <span className="text-zinc-500 font-mono text-[10.5px] uppercase">Security Level</span>
                            <span className="text-zinc-300 font-medium">{currentFeatures.security}</span>
                          </div>
                          <div className="flex justify-between border-b border-[#0F0F8B]/20 pb-1.5">
                            <span className="text-zinc-500 font-mono text-[10.5px] uppercase">Safety Features</span>
                            <span className="text-zinc-300 font-medium">{currentFeatures.safety}</span>
                          </div>
                          <div className="flex justify-between border-b border-[#0F0F8B]/20 pb-1.5">
                            <span className="text-zinc-500 font-mono text-[10.5px] uppercase">Performance</span>
                            <span className="text-zinc-300 font-medium">{currentFeatures.performance}</span>
                          </div>
                          <div className="flex justify-between pb-0">
                            <span className="text-zinc-500 font-mono text-[10.5px] uppercase">Service Status</span>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button 
                    ...
                    className={`w-full py-2.5 rounded-xl text-[11px] font-bold uppercase tracking-wider transition-all duration-300 border cursor-pointer active:scale-98 flex items-center justify-center gap-2 ${
                      showSpecialFeatures 
                  ...
                  <div className="border-t border-[#0F0F8B]/20 pt-4 flex items-center justify-between">
                    <div className="flex flex-col text-left">
                      <span className="text-[9.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Deployment</span>
          ...
          <div className="lg:col-span-6 flex justify-center items-center w-full relative">
            ...
            <div className="w-full max-w-[270px] aspect-[9/18.5] p-2.5 rounded-[2.85rem] bg-[#080870] border border-[#0F0F8B]/30 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.7)] flex items-center justify-center relative z-10">
              ...
              <div className="w-full h-full rounded-[2.15rem] bg-[#0A0A78] overflow-hidden relative shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] flex flex-col justify-between select-none">
                ...
                <div className="pt-3 pb-1.5 px-5 bg-[#080870] border-b border-[#0F0F8B]/20 flex justify-between items-center text-[11px] font-mono font-bold text-zinc-500 relative z-30">
                  <span>08:13</span>
                ...
                <div className="flex-grow flex flex-col justify-between p-3 relative overflow-hidden bg-[#0A0A78]/20">
                  ...
                  <div className="flex justify-between items-center mb-1 z-20">
                    <div className="flex flex-col text-left">
                      <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-500 font-mono">Operations</span>
                      <span className="text-[12px] font-bold text-white leading-none">Active Unit</span>
                    </div>
                    <span className="text-[10px] font-bold font-mono px-2 py-0.5 border border-[#0F0F8B]/30 rounded-md text-zinc-400 bg-[#080870]/80">
                  ...
                  <div className="flex flex-col gap-1 z-20">
                    <span className="text-[9.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono text-left block">
                      Camera Angles
                    </span>
                  ...
                  <div className="bg-[#080870]/70 border border-[#0F0F8B]/20 rounded-xl p-2 flex items-center gap-1.5 mt-2 z-20">
                    ...
                    <span className="text-[10px] font-bold text-zinc-300 truncate text-left w-full">
                ...
                <div className="p-3.5 bg-[#080870] border-t border-[#0F0F8B]/20 flex justify-between items-center relative z-20">
                  ...
                  <button 
                    onClick={handleReserve}
                    className="bg-[#0000FD] hover:bg-white text-[#080870] text-[10.5px] font-bold px-3 py-2 rounded-lg uppercase tracking-widest transition-all active:scale-95 cursor-pointer flex items-center gap-1 shadow-md shadow-[#0F0F8B]/30"
                  >
        ...
        <div className="lg:hidden flex flex-col gap-6 w-full">
          ...
          <div className="bg-[#0A0A78]/40 border border-[#0F0F8B]/20 rounded-[2.5rem] p-1.5 shadow-2xl relative w-full overflow-hidden">
            ...
            <div className="bg-[#080870]/95 rounded-[calc(2.5rem-0.375rem)] p-5 shadow-[inset_0_1px_1px_rgba(255,255,255,0.03)] flex flex-col gap-5 text-left select-none relative z-10">
              ...
              <div className="flex justify-between items-center">
                <span className="inline-block text-[11px] font-bold font-mono text-[#0000FD] uppercase tracking-widest bg-[#0000FD]/10 border border-[#0000FD]/20 px-2.5 py-0.5 rounded-md">
                  {activeVehicle.category === 'suvs' ? 'SUV' : activeVehicle.category === 'luxury' ? 'Luxury' : 'Security'}
                </span>
                <span className="text-[12px] font-bold font-mono text-zinc-500 bg-[#0A0A78]/80 px-2 py-0.5 rounded-md border border-[#0F0F8B]/20">
                  {activeIndex + 1} / {FLEET_DATA.length}
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 py-1 border-t border-b border-[#0F0F8B]/20 my-1">
                <div className="flex flex-col items-center justify-center p-2 bg-[#0A0A78]/50 rounded-xl">
                  ...
                  <span className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest">Seats</span>
                  <span className="text-xs font-bold text-zinc-300">{activeVehicle.specs.pax.split(' ')[2] || '5'} Max</span>
                </div>
                <div className="flex flex-col items-center justify-center p-2 bg-[#0A0A78]/50 rounded-xl">
                  <Briefcase size={14} className="text-[#0000FD] mb-0.5" />
                  <span className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest">Bags</span>
                ...
                <div className="flex flex-col items-center justify-center p-2 bg-[#0A0A78]/50 rounded-xl">
                  ...
                  <span className="text-[9px] text-zinc-500 font-mono uppercase tracking-widest">Class</span>
                  <span className="text-xs font-bold text-zinc-300 truncate w-full text-center">{activeVehicle.specs.type.split(' ')[0]}</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 bg-[#0A0A78]/40 border border-[#0F0F8B]/20 rounded-xl p-3 text-xs text-zinc-400">
                <span className="text-[10.5px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Features</span>
                <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col items-center gap-2 mt-2">
            <div className="flex items-center gap-2.5 text-[12px] font-mono uppercase tracking-widest text-white font-bold bg-[#0F0F8B]/50 border border-[#0F0F8B]/40 px-4 py-2 rounded-full">
              <motion.span 
                animate={{ x: [-4, 4, -4] }} 
