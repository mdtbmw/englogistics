  ...
  return (
    <div className="pt-32 md:pt-40 pb-28 px-4 md:px-8 max-w-7xl mx-auto w-full text-left">
      <div className="text-center mb-8 md:mb-12 flex flex-col items-center gap-2">
        ...
        <div>
          <span className="text-[13px] font-mono text-[#0F0F8B] uppercase tracking-widest block mb-1">Booking Desk</span>
        ...
        {!bookingConfirmed ? (
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-zinc-100 pb-3">
                <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-widest flex items-center gap-2">
                  <Receipt size={16} className="text-[#0F0F8B]" />
                  1. Booking Details
                </h3>
                <button 
                  type="button"
                  ...
                  className="lg:hidden text-xs font-bold text-[#0F0F8B] uppercase tracking-wider cursor-pointer"
                >
                  Done
                </button>
              </div>
              ...
              <div className="bg-zinc-50 border border-zinc-150 rounded-2xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-3.5 mt-2">
                <div className="flex items-center gap-3 text-left">
                  <div className="relative flex h-2 w-2 shrink-0">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#0F0F8B] opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-[#0F0F8B]"></span>
                  </div>
                  <div>
                    <span className="text-[14px] font-bold text-zinc-900 uppercase tracking-widest font-mono block">Secure Booking</span>
                    <span className="text-[13.5px] text-zinc-500 font-sans block mt-0.5">Your information is safe with us</span>
                  </div>
                </div>
                <div className="bg-zinc-100 text-zinc-700 text-[12.5px] font-bold font-mono px-2.5 py-1 rounded border border-zinc-200 uppercase tracking-wider shrink-0">
                  Secured Desk
                </div>
              </div>

              {errorMessage && (
                <div className="bg-amber-50 text-amber-800 border border-amber-200/50 p-3.5 rounded-xl text-[13px] font-sans">
                  {errorMessage}
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Client Name</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-zinc-50 border border-zinc-200 focus:border-[#0F0F8B] focus:bg-white rounded-xl py-3 pl-10 pr-4 text-xs font-medium text-zinc-800 outline-none transition-all placeholder:text-zinc-400"
                    />
                  </div>
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Secure Email</label>
                  <div className="relative">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Direct Secure Phone</label>
                  <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Escort</label>
                  <CustomDropdown
                    options={[
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Vehicle Selection</label>
                  <CustomDropdown
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Departure</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-zinc-50 border border-zinc-200 focus:border-[#0F0F8B] focus:bg-white rounded-xl py-3 pl-10 pr-4 text-xs font-medium text-zinc-800 outline-none transition-all"
                    />
                  </div>
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Destination</label>
                  <div className="relative">
                    <MapPin size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-400" />
                    <input 
                      type="text" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Date</label>
                  <div className="relative">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Departure Time</label>
                  <div className="relative">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">No. of Days</label>
                  <input 
                    type="number" 
                    required 
                    min={1} 
                    ...
                    className="w-full bg-zinc-50 border border-zinc-200 focus:border-[#0F0F8B] focus:bg-white rounded-xl py-3 px-4 text-xs font-medium text-zinc-800 outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 pt-2">
                <label className="text-[13px] font-bold text-zinc-500 uppercase tracking-wider font-mono">UPGRADES</label>
                    ...
                    <button
                      ...
                      className={`p-4 rounded-2xl border text-left transition-all flex flex-col justify-between min-h-[110px] md:min-h-[140px] cursor-pointer ${
                        securityLevel === opt.level 
                          ? 'border-[#0000FD] bg-[#0000FD]/10 text-[#0000FD] font-bold' 
                          : 'border-zinc-200 bg-white hover:border-zinc-300'
                      }`}
                    >
                      <div>
                        <span className="text-[14px] font-bold uppercase tracking-wide block">{opt.title}</span>
                        <span className="text-[13px] text-[#0F0F8B] font-mono block mt-1">{opt.surcharge}</span>
                      </div>
                      <p className="text-[13.5px] text-zinc-500 font-medium leading-relaxed font-sans mt-2 md:mt-3">
                        {opt.desc}
                      </p>
                    </button>
                  ))}
              ...
              <div className="pt-4">
                <button 
                  type="submit"
                  className="w-full bg-[#0F0F8B] text-white font-bold text-xs py-4.5 rounded-xl hover:bg-[#080870] transition-colors flex items-center justify-center gap-2 uppercase tracking-widest active:scale-95 cursor-pointer shadow-lg shadow-[#0F0F8B]/20"
                >
            ...
            <div className="lg:col-span-5 space-y-6 w-full">
              <div className="bg-gradient-to-br from-[#0F0F8B] to-[#080870] text-white rounded-[2rem] border border-[#0F0F8B]/30 p-6 md:p-8 space-y-6 relative overflow-hidden shadow-xl">
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#0F0F8B]/10 rounded-full blur-3xl pointer-events-none"></div>

                <div className="flex items-center justify-between border-b border-[#0F0F8B]/30 pb-4">
                  <div>
                    <span className="text-[12px] font-mono text-[#0000FD] uppercase tracking-[0.2em] block">Desk Verification</span>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-white mt-1">Reservation Statement</h3>
                  </div>
                  <span className="text-[12px] font-mono bg-[#0000FD]/10 text-[#0000FD] border border-[#0000FD]/20 px-2 py-0.5 rounded-md uppercase tracking-wider">
                    Authorized Summary
                  </span>
                </div>

                <div className="flex flex-col gap-3.5 bg-[#0A0A78]/60 p-4 border border-[#0F0F8B]/30 rounded-2xl">
                  <div className="flex items-center gap-4">
                    <img src={selectedVehicle.image} alt={selectedVehicle.name} className="w-20 h-14 object-cover rounded-xl border border-[#0F0F8B]/20 shrink-0" />
                    <div className="text-left flex-1 min-w-0">
                      <span className="text-[12px] font-bold text-zinc-500 uppercase font-mono block">Selected Vehicle Class</span>
                      <span className="text-xs font-semibold text-white uppercase block mt-0.5 truncate">{selectedVehicle.name}</span>
                      <span className="text-[13px] text-[#0000FD] font-mono block mt-0.5 font-bold font-mono">
                        Elite Transit Class
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2 border-t border-[#0F0F8B]/20 text-[13px] font-mono">
                    <div className="bg-[#080870]/70 rounded-lg p-2 border border-[#0F0F8B]/30 text-center">
                      <span className="text-[11.5px] text-zinc-400 uppercase block">Pax Cap</span>
                      <span className="text-zinc-300 font-bold block mt-0.5">{selectedVehicle.specs.pax.replace('Up to ', '')}</span>
                    </div>
                    <div className="bg-[#080870]/70 rounded-lg p-2 border border-[#0F0F8B]/30 text-center">
                      <span className="text-[11.5px] text-zinc-400 uppercase block">Luggage</span>
                      <span className="text-zinc-300 font-bold block mt-0.5">{selectedVehicle.specs.luggage.split(' ')[0]}</span>
                    </div>
                    <div className="bg-[#080870]/70 rounded-lg p-2 border border-[#0F0F8B]/30 text-center">
                      <span className="text-[11.5px] text-zinc-400 uppercase block">Specs Type</span>
                      <span className="text-zinc-300 font-bold block mt-0.5 truncate">{selectedVehicle.specs.type.split(' ')[0]}</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-3 pt-2 text-[13px] font-mono">
                  <div className="flex justify-between items-center text-zinc-400 border-b border-[#0F0F8B]/30 pb-2.5">
                  ...
                  <div className="flex justify-between items-baseline pt-3 border-t border-[#0F0F8B]/30 text-sm font-sans font-bold">
                    <span className="text-zinc-300">RATE SPECIFICATION:</span>
                    <span className="text-[#0000FD] text-xs font-mono uppercase">Custom Quote On-Demand</span>
                  </div>
                </div>

                <div className="bg-[#0A0A78]/50 p-3.5 border border-[#0F0F8B]/30 rounded-xl space-y-1.5 text-[14px] text-zinc-400 font-sans leading-relaxed">
                   <div className="flex items-start gap-2">
                     <ShieldCheck size={12} className="text-[#0000FD] shrink-0 mt-0.5" />
                ...
                <div className="border-t border-[#0F0F8B]/20 pt-4 mt-2">
                  <p className="text-[12.5px] font-mono text-zinc-500 uppercase tracking-wider leading-relaxed">
              ...
              {!isDrawerOpen && (
                <div className="lg:hidden fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-md border-t border-zinc-150 z-40 shadow-lg">
                  <button 
                    ...
                    className="w-full bg-[#0F0F8B] text-white font-bold text-xs py-4 rounded-xl flex items-center justify-center gap-2 uppercase tracking-widest active:scale-95 cursor-pointer shadow-lg shadow-[#0F0F8B]/30"
                  >
          ...
          >
            ...
            <div className="flex flex-row justify-between items-center bg-zinc-50 border border-zinc-150 p-4.5 rounded-2xl no-print gap-3">
              <span className="text-[13px] font-bold text-zinc-500 uppercase tracking-widest font-mono hidden sm:inline">Protocol Desk</span>
              <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
                <button
                  type="button"
                  onClick={() => window.print()}
                  className="bg-[#0F0F8B] text-white text-[14px] font-bold px-4 py-2.5 rounded-xl uppercase tracking-wider hover:bg-[#080870] transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="bg-green-600 text-white text-[14px] font-bold px-4.5 py-2.5 rounded-xl uppercase tracking-wider hover:bg-green-700 transition-colors flex items-center gap-1.5 cursor-pointer shadow-md shadow-green-650/15"
                >
            ...
            <div className="flex flex-col items-center text-center gap-3">
              <div className="w-16 h-16 bg-[#0000FD]/15 border border-[#0000FD]/30 rounded-full flex items-center justify-center text-[#0000FD] shadow-lg p-3 animate-bounce">
<LogoIcon className="w-16 h-16" />
              </div>
              <div>
                <span className="text-[#0000FD] text-[14px] font-bold font-mono uppercase tracking-[0.25em] block">Booking Confirmed</span>
            ...
            <div className="flex flex-col items-center justify-center py-4 bg-zinc-50 border border-zinc-100 rounded-2xl">
              ...
              <span className="text-[12.5px] font-mono text-zinc-500 uppercase tracking-widest mt-2">{receiptNumber} - ENG TRAVELS LOG</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 border-y border-zinc-100 py-6 text-xs font-sans">
              <div>
                 <span className="text-[13.5px] text-zinc-400 font-mono block uppercase">Client</span>
              ...
              <div>
                 <span className="text-[13.5px] text-zinc-400 font-mono block uppercase">Vehicle</span>
                 <span className="font-bold text-[#0F0F8B] block mt-1 uppercase">{selectedVehicle.name}</span>
              ...
              <div>
                 <span className="text-[13.5px] text-zinc-400 font-mono block uppercase">Departure</span>
              ...
              <div>
                 <span className="text-[13.5px] text-zinc-400 font-mono block uppercase">Destination</span>
            ...
            <div className="flex flex-col sm:flex-row gap-3 no-print">
              <button 
                onClick={handleReset}
                className="flex-1 bg-zinc-100 text-zinc-700 text-[14px] font-bold py-3.5 rounded-xl text-center uppercase tracking-widest cursor-pointer hover:bg-zinc-200 active:scale-95 transition-all"
              >
                Book Again
              </button>
              {setView && (
                <button 
                  ...
                  className="flex-1 bg-[#0F0F8B] text-white text-[14px] font-bold py-3.5 rounded-xl text-center uppercase tracking-widest cursor-pointer hover:bg-[#080870] transition-colors flex items-center justify-center gap-1.5 active:scale-95 transition-all"
                >
