  ...
  return (
    <div className="pt-32 md:pt-40 pb-28 px-4 md:px-8 max-w-7xl mx-auto w-full text-left">
      <div className="text-center mb-8 md:mb-12 flex flex-col items-center gap-2">
        ...
        <div>
          <span className="text-[15px] font-mono text-[#0F0F8B] uppercase tracking-widest block mb-1">Booking Desk</span>
            ...
            >
              ...
              <div className="bg-zinc-50 border border-zinc-150 rounded-2xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-3.5 mt-2">
                <div className="flex items-center gap-3 text-left">
                  ...
                  <div>
                    <span className="text-[16px] font-bold text-zinc-900 uppercase tracking-widest font-mono block">Secure Booking</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[15px] font-bold text-zinc-500 uppercase tracking-wider font-mono">Escort</label>
                  <CustomDropdown
                    options={[
                  ...
                  {[
                    ...
                    >
                      <div>
                        ...
                        <span className="text-[15px] text-[#0F0F8B] font-mono block mt-1">{opt.surcharge}</span>
                      </div>
            ...
            <div className="lg:col-span-5 space-y-6 w-full">
              <div className="bg-gradient-to-br from-[#0F0F8B] to-[#080870] text-white rounded-[2rem] border border-[#0F0F8B]/30 p-6 md:p-8 space-y-6 relative overflow-hidden shadow-xl">
                ...
                <div className="flex items-center justify-between border-b border-[#0F0F8B]/30 pb-4">
                  <div>
                    <span className="text-[14px] font-mono text-[#0000FD] uppercase tracking-[0.2em] block">Desk Verification</span>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-white mt-1">Reservation Statement</h3>
                  </div>
                  <span className="text-[14px] font-mono bg-[#0000FD]/10 text-[#0000FD] border border-[#0000FD]/20 px-2 py-0.5 rounded-md uppercase tracking-wider">
                    Authorized Summary
                  </span>
                </div>
                ...
                <div className="flex flex-col gap-3.5 bg-[#0A0A78]/60 p-4 border border-[#0F0F8B]/30 rounded-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left flex-1 min-w-0">
                      ...
                      <span className="text-[15px] text-[#0000FD] font-mono block mt-0.5 font-bold font-mono">
                        Elite Transit Class
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2 border-t border-[#0F0F8B]/20 text-[15px] font-mono">
                ...
                <div className="space-y-3 pt-2 text-[15px] font-mono">
                  <div className="flex justify-between items-center text-white/70 border-b border-[#0F0F8B]/30 pb-2.5">
                ...
                <div className="bg-[#0A0A78]/50 p-3.5 border border-[#0F0F8B]/30 rounded-xl space-y-1.5 text-[16px] text-white/70 font-sans leading-relaxed">
            ...
            <div className="flex flex-row justify-between items-center bg-zinc-50 border border-zinc-150 p-4.5 rounded-2xl no-print gap-3">
              ...
              <div className="flex items-center gap-2.5 w-full sm:w-auto justify-end">
                <button
                  ...
                  className="bg-[#0F0F8B] text-white text-[16px] font-bold px-4 py-2.5 rounded-xl uppercase tracking-wider hover:bg-[#080870] transition-colors flex items-center gap-1.5 cursor-pointer"
                >
...
<LogoIcon className="w-16 h-16" />
              ...
              <div>
                <span className="text-[#0000FD] text-[16px] font-bold font-mono uppercase tracking-[0.25em] block">Booking Confirmed</span>
            ...
            <div className="flex flex-col sm:flex-row gap-3 no-print">
              ...
              {setView && (
                <button 
                  ...
                  className="flex-1 bg-[#0F0F8B] text-white text-[16px] font-bold py-3.5 rounded-xl text-center uppercase tracking-widest cursor-pointer hover:bg-[#080870] transition-colors flex items-center justify-center gap-1.5 active:scale-95 transition-all"
                >
