  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      <button
        ...
        className="w-full bg-zinc-50 border border-zinc-200 focus:border-[#0F0F8B] focus:bg-white rounded-xl py-3 px-4 text-xs font-medium text-zinc-800 outline-none transition-all flex items-center justify-between cursor-pointer active:scale-[0.99] select-none text-left"
      >
