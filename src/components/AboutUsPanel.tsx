...
export default function AboutUsPanel({ setView }: AboutUsPanelProps) {
  const values = [
    { 
      ...
      icon: <Shield size={22} className="text-[#0F0F8B]" /> 
    },
    { 
      letter: 'M', 
      ...
      icon: <Compass size={22} className="text-[#0F0F8B]" /> 
    },
    { 
      letter: 'I', 
      name: 'Integrity', 
      ...
      icon: <Lock size={22} className="text-[#0F0F8B]" /> 
    },
    { 
      letter: 'L', 
      name: 'Leadership', 
      ...
      icon: <Zap size={22} className="text-[#0F0F8B]" /> 
    },
    { 
      letter: 'E', 
      ...
      icon: <Star size={22} className="text-[#0F0F8B]" /> 
    }
  ];
    ...
    <div className="pt-32 md:pt-40 pb-20 px-4 md:px-8 max-w-7xl mx-auto w-full text-left">
      ...
      <section id="about-hero" className="mb-20 bg-gradient-to-br from-[#0F0F8B] to-[#080870] rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden text-white shadow-2xl">
        ...
        <div className="relative z-10 max-w-3xl">
          <h2 className="text-[12px] font-bold text-[#0000FD] uppercase tracking-[0.25em] mb-4 font-mono">Corporate Profile</h2>
          ...
          <div className="flex gap-4">
            <button 
              ...
              className="bg-[#0000FD] text-[#080870] text-[12.5px] font-bold px-7 py-4 rounded-xl hover:bg-white transition-all uppercase tracking-widest active:scale-95 shadow-lg shadow-[#0F0F8B]/30 cursor-pointer"
            >
              Book a Ride
            </button>
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-24 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          <div className="space-y-2">
            <h2 className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-widest font-mono">Our Narrative</h2>
        ...
        <div className="lg:col-span-5 relative w-full flex justify-center">
          <div className="relative w-full max-w-[400px] aspect-square rounded-[2rem] border border-zinc-200 shadow-xl overflow-hidden group">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#080870] via-[#080870]/40 to-transparent"></div>
            
            {/* Floating Information Overlay */}
            <div className="absolute bottom-6 left-6 right-6 text-left">
              <span className="text-[11px] font-mono text-[#0000FD] uppercase tracking-widest font-bold block mb-1">Fleet Telemetry</span>
              <span className="text-sm font-semibold text-white uppercase block">Nationwide Routing Desk</span>
              <span className="text-zinc-400 text-[12px] block mt-1">Benin Head Office • Lagos Protocol Desk</span>
            </div>
          </div>
          
          {/* Overlapping Detail Badge Card */}
          <div className="absolute top-4 left-1/2 -translate-x-1/2 lg:top-auto lg:bottom-[-24px] lg:left-[-32px] lg:translate-x-0 bg-gradient-to-br from-[#0F0F8B] to-[#080870] border border-[#0F0F8B]/30 text-white rounded-2xl p-5 shadow-2xl flex items-center gap-3.5 max-w-[220px] text-left animate-pulse-slow z-20">
            <div className="w-10 h-10 bg-[#0000FD]/10 border border-[#0000FD]/20 rounded-xl flex items-center justify-center text-[#0000FD] shrink-0">
              <Award size={20} />
            </div>
            <div>
              <span className="text-[10.5px] font-mono text-[#0000FD] uppercase font-bold block">Certified SLA</span>
      ...
      <section className="mb-24">
        <div className="text-center max-w-xl mx-auto mb-12">
          <h2 className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-[0.2em] mb-2 font-mono">Our Mandate</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-zinc-200/80 rounded-[2rem] p-8 md:p-12 relative overflow-hidden text-left shadow-lg hover:shadow-xl hover:border-[#0F0F8B]/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between min-h-[320px] group">
            {/* Top golden accent line */}
            <div className="absolute top-0 left-0 w-full h-[4px] bg-[#0F0F8B]"></div>
            
            {/* Soft decorative golden glow */}
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#0F0F8B]/5 rounded-full blur-2xl pointer-events-none transition-opacity duration-500 group-hover:bg-[#0F0F8B]/10"></div>
            
            <div className="relative z-10 space-y-6">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 bg-[#0F0F8B]/5 border border-[#0F0F8B]/15 rounded-2xl flex items-center justify-center text-[#0F0F8B] group-hover:scale-110 transition-transform duration-500">
                  <Target size={24} />
                </div>
                <span className="text-4xl font-extrabold text-zinc-100 font-mono tracking-tighter group-hover:text-[#0F0F8B]/20 transition-colors duration-500">
                  01
                </span>
              </div>
              <div className="space-y-3">
                <span className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-[0.2em] font-mono block">Our Mission</span>
          ...
          <div className="bg-white border border-zinc-200/80 rounded-[2rem] p-8 md:p-12 relative overflow-hidden text-left shadow-lg hover:shadow-xl hover:border-[#0F0F8B]/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between min-h-[320px] group">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                <span className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-[0.2em] font-mono block">Our Vision</span>
                <h4 className="text-lg font-semibold text-zinc-900 tracking-tight leading-snug font-sans">
      ...
      <section className="mb-24">
        <div className="mb-12 text-left">
          <h2 className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-widest mb-2 font-mono">Our Foundation</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {values.map((v) => (
            <div key={v.letter} className="bg-white border border-zinc-150 rounded-2xl p-6 hover:border-[#0F0F8B]/30 hover:shadow-lg transition-all duration-300 flex flex-col justify-between min-h-[280px] group text-left">
              <div>
                <div className="flex items-center justify-between mb-8">
                  <div className="w-11 h-11 bg-zinc-50 rounded-xl flex items-center justify-center group-hover:bg-[#0F0F8B]/10 transition-colors duration-300">
                    {v.icon}
                  </div>
      ...
      <section className="bg-zinc-50 border border-zinc-100 rounded-[2.5rem] p-8 md:p-14 mb-24">
        <div className="mb-12 text-left">
          <h2 className="text-[12px] font-bold text-[#0F0F8B] uppercase tracking-widest mb-2 font-mono">Operational Excellence</h2>
      ...
      <section className="bg-gradient-to-br from-[#0F0F8B] to-[#080870] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl border border-[#0F0F8B]/30">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-[#0000FD]/10 rounded-full blur-3xl pointer-events-none"></div>
        
        <div className="relative z-10 max-w-2xl mx-auto space-y-6 flex flex-col items-center">
          <div className="w-14 h-14 bg-[#0000FD]/15 border border-[#0000FD]/30 rounded-full flex items-center justify-center text-[#0000FD] p-3 shadow-lg">
            <Shield size={28} />
          </div>
          
          <div className="space-y-2">
            <span className="text-[11px] font-mono text-[#0000FD] uppercase tracking-[0.25em] font-bold">Our Service Promise</span>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center gap-4.5 w-full justify-center">
            <button 
              onClick={() => setView('booking')}
              className="w-full sm:w-auto bg-[#0000FD] text-[#080870] text-[12px] font-bold px-8 py-4 rounded-xl hover:bg-white transition-all uppercase tracking-widest active:scale-95 shadow-lg shadow-[#0F0F8B]/30 cursor-pointer"
            >
              Book a Ride
            </button>
            <span className="text-[12px] font-bold text-zinc-500 uppercase tracking-widest font-mono block sm:inline">
