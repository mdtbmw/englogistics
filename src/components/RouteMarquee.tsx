...
export default function RouteMarquee() {
  return (
    <div className="w-full overflow-hidden bg-gradient-to-r from-[#f0f5ff] to-[#e8f0fe] py-4.5 border-y border-[#0F0F8B]/10 mb-16 relative">
      ...
      <div className="animate-marquee flex items-center gap-10">
        {DESTINATIONS.map((dest, i) => (
          <div key={i} className="flex items-center gap-10 shrink-0">
            <span className="text-[12.5px] font-bold text-zinc-500 uppercase tracking-[0.2em] font-mono">
              {dest}
            </span>
