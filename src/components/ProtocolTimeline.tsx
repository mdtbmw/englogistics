...
export default function ProtocolTimeline() {
  ...
  return (
    <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto w-full overflow-hidden text-left">
      ...
      >
         <h2 className="text-[10px] font-bold text-[#0152FA] uppercase tracking-widest mb-2 font-mono">Operations Pipeline</h2>
      ...
      >
        {steps.map((step, idx) => (
          <motion.div 
            ...
            className="w-full md:w-[290px] md:shrink-0 md:snap-center bg-white border border-zinc-150 rounded-2xl p-6 relative group hover:border-[#0152FA]/40 hover:shadow-lg transition-all duration-300 cursor-default"
          >
            {idx !== steps.length - 1 && (
            ...
            <div className="relative z-10 flex flex-col gap-5">
               <div className="flex items-center justify-between">
                 <div className="w-10 h-10 bg-zinc-50 text-[#0152FA] rounded-xl flex items-center justify-center group-hover:bg-[#0152FA] group-hover:text-white transition-colors duration-300">
                   {step.icon}
                 </div>
