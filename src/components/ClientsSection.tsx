...
export default function ClientsSection() {
  ...
  return (
    <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto w-full overflow-hidden">
      ...
      >
        <h2 className="text-[10px] font-bold text-[#0152FA] uppercase tracking-widest mb-2 font-mono">Our Clients</h2>
      ...
      >
        ...
        <div className="flex gap-12 items-center animate-marquee py-4">
          {[...clients, ...clients].map((client, idx) => (
            <div
              key={idx}
              className="flex-shrink-0 w-[160px] h-[80px] bg-white border border-zinc-100 rounded-xl flex items-center justify-center p-4 shadow-sm hover:shadow-md hover:border-[#0152FA]/20 transition-all duration-300"
            >
              <img
                src={client.logo}
                alt={client.name}
