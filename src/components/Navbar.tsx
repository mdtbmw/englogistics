        ...
        <div className={`transition-all duration-500 flex items-center justify-between px-6 py-3.5 max-w-7xl mx-auto rounded-2xl ${
          ...
          <div className="hidden lg:flex items-center gap-5">
            {navItems.map((item) => (
              <button
                ...
                className={`text-[15px] font-bold py-1.5 px-3 rounded-lg uppercase tracking-wider transition-all cursor-pointer relative ${
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button 
              ...
              className="bg-[#050548] text-white text-[15px] font-bold px-5 py-2.5 rounded-xl hover:bg-[#030330] transition-colors uppercase tracking-widest active:scale-95 cursor-pointer shadow-md"
            >
              Book a Ride
            </button>
          </div>
