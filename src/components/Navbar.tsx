        ...
        <div className={`transition-all duration-500 flex items-center justify-between px-6 py-3.5 max-w-7xl mx-auto rounded-2xl ${
          ...
          >
            ...
            <div>
              ...
              <span className="text-[15px] font-mono text-zinc-400 uppercase tracking-widest block -mt-1">LOGISTICS</span>
            </div>
          </button>
          ...
          <div className="hidden lg:flex items-center gap-4">
            <button 
              ...
              className="bg-[#0F0F8B] text-white text-[16px] font-bold px-5 py-3 rounded-xl hover:bg-[#080870] transition-colors uppercase tracking-widest active:scale-95 cursor-pointer shadow-md"
            >
              Book a Ride
            </button>
          </div>
            ...
            <div className="bg-white/98 backdrop-blur-xl border border-zinc-100 rounded-2xl shadow-xl p-6 flex flex-col gap-4">
              ...
              <div className="border-t border-zinc-100 pt-4 mt-2 flex flex-col gap-3">
                <button 
                  ...
                  className="w-full bg-[#0F0F8B] text-white text-[16px] font-bold py-3 px-4 rounded-xl text-center uppercase tracking-widest active:scale-95"
                >
                  Book a Ride
                </button>
              </div>
